...
const transporter = nodemailer.createTransport(
  sendgridTransport({
    auth: {
      api_key:
        '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'
    }
  })
);

const sgMail = require('@sendgrid/mail')
sgMail.setApiKey('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' || process.env.SENDGRID_API_KEY);
